...
MODULES = [
  ...
  'src/gradschool.js', 'src/mindset.js', 'src/devcourse.js', 'src/pmcourse.js', 'src/datacourse.js', 'src/eqcourse.js', 'src/labcourse.js', 'src/widercourse.js', 'src/thesis.js', 'src/gate.js', 'src/routes.js', 'src/notes.js', 'src/telemetry.js', 'src/assistant.js', 'src/walkthrough.js', 'src/deskws.js', 'src/packet_data.js', 'src/packet.js', 'src/geoexport.js', 'src/switchboard.js', 'src/coverage.js', 'src/permalink.js', 'src/cover.js',
]

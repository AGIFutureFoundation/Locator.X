...
|---|---|---|
| 1 | Fits an approved sleeve and market | The buy box in `src/underwrite.js` (552) and the view builder in `src/views.js` (189) |
...
| 5 | Has confidence-scored supporting data and clearly logged open questions | `src/evidence.js` (223) grades the inputs; `src/coverage.js` (227) states what the edition cannot answer at all |

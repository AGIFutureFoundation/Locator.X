...
|---|---|---|---|
| **Locator.X Intelligence** | Unified property, market, owner, comp and risk data | `src/app.js` (1764) record layer, `src/evidence.js` (233) per-source grading, `src/sources.js` (176) source catalogue, `src/comps.js` (297) recorded-sale comparables, `src/signals.js` (173) outside forces | **partial** — 8 editions shipped against 90 coverage-gate rows; **owner data is excluded by policy**, see the open question below |

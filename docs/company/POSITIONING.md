...
| **Locator.X Strategy Engine** | Investment scenario and capital-stack comparison | `src/switchboard.js` (455) five strategies over one record, each graded by the facts it rests on; `src/underwrite.js` (595) ten financing structures and the offer solver | **ships** |

...
pool=json.load(open(R+'uscorridor_pool4_wide.json'))
...
for i,o in enumerate(pool,1):
    ...
    cd=o['src'].split('.')[0] + '.'
    listings.append(dict(id='UW%06d'%i, addr=o['addr'], city=o['city'], zip=o['zip'],
        ...
        cv=1 if (o['units'] or 0)>=5 else None))
...
region=dict(name='US Corridor Conversion Stock', center=[-95.0, 38.5], zoom=3.9,
...
decoder='''var _n=0;
var listings=R.map(function(r){_n++;var t=String(_n);while(t.length<6)t="0"+t;var o={id:"UW"+t,addr:r[0],city:D.city[r[1]],zip:r[2]==null?"":String(r[2]).padStart(5,"0"),county:D.county[r[3]],nb:r[4]==null?null:D.nb[r[4]],anb:null,lat:+((24+r[6]/1e5).toFixed(5)),lng:+((r[7]/1e5-125).toFixed(5)),kind:D.kind[r[8]],units:r[9],beds:null,baths:null,rooms:null,sqft:r[11],lot:r[12],year:r[13],stories:null,price:r[10],priceDate:null,land:null,imp:null,zoning:r[17]==null?null:D.zoning[r[17]],apn:r[14],classdef:D.cls[r[15]],src:D.src[r[16]],tour:null};if(r[18])o.cv=1;if(r[19]!=null)o.beds=r[19];if(r[20]!=null)o.baths=r[20];if(r[21]!=null)o.stories=r[21];if(r[22]!=null)o.sale=r[22];if(r[23]!=null)o.campKm=r[23]/10;if(r[24]!=null)o.projKm=r[24]/10;if(r[25]!=null){var _d=String(r[25]);o.saleDate=_d.slice(0,4)+"-"+_d.slice(4,6)+"-"+_d.slice(6,8);}if(r[26])o.saleUndated=1;return o;});
R=null;D=null;
...
s=('window.BA=(function(){"use strict";var D='+j(D)+';var R='+j(rows)+';var M='+j(market)
   +';var G='+j(geo)+';var REGION='+j(region)+';var B="2026-09-04-USWIDE";\n'+decoder+'\n})();')
open(R+'raw/data_uswide.js','w').write(s)
print('raw bytes', len(s))
import sys; sys.path.insert(0,R)
from compress_data import compress
r=compress(R+'raw/data_uswide.js', R+'data_uswide.js')
print('data_uswide.js', round(r['before']/1e6,2),'->',round(r['after']/1e6,2),'MB', r['literals'])
